...
export default function Header({
  ...
  return (
    <>
      <header className="relative z-20 flex flex-wrap items-center justify-between gap-3 px-4 md:px-8 py-3 border-b border-white/5 bg-black/60 backdrop-blur-xl">
        {/* Brand & Tagline */}
